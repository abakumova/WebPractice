...
<head>
    ...
    <script src="../laboratorna_2/assets/js/usersTable.js"></script>
    <script src="../laboratorna_2/assets/js/loginFormValidation.js"></script>
    <script src="../laboratorna_2/assets/js/regFormValidation.js"></script>
    <script src="../laboratorna_2/assets/js/addUserValidation.js"></script>
    <meta charset="UTF-8">
